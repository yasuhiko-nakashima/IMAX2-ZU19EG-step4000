...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E006C 0x013F3F07 0x01011602
    ...
    mask_write 0XFF5E0070 0x013F3F07 0x01010B02
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180144 0x03FFFFFF 0x03FFF3FF
    ...
    mask_write 0XFF18015C 0x03FFFFFF 0x01FFEAB7
    ...
    mask_write 0XFF180178 0x03FFFFFF 0x02FBFFC0
    ...
    mask_write 0XFF180184 0x03FFFFFF 0x03FF403F
		# : LOOPBACK
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF5E0230 0x00000006 0x00000000
		# : QSPI
		# Register : RST_LPD_IOU2 @ 0XFF5E0238</p>
    ...
    mask_write 0XFF0A0244 0x03FFFFFF 0x00000008
		# : DIR MODE BANK 2
    ...
    mask_write 0XFF0A0248 0x03FFFFFF 0x00000008
    ...
    mask_write 0XFF0A0008 0xFFFFFFFF 0xFFF70008
    ...
    mask_write 0XFF0A0008 0xFFFFFFFF 0xFFF70000
		# : MASK_DATA_1_MSW HIGH BANK [51:42]
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
		# : MASK_DATA_1_LSW HIGH BANK [77:68]
		# : ADD 5US DELAY
...
set psu_resetout_init_data {
    ...
    mask_write 0XFD48001C 0x0000FFFF 0x0000E000
