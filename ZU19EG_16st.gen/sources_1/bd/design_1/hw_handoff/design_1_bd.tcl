...
proc create_root_design { parentCell } {
  ...
  set emax6_0 [ create_bd_cell -type ip -vlnv comparch:user:emax6:1.0 emax6_0 ]
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins emax6_0/axi_s]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_smc/aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins axi_smc/aclk1] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins emax6_0/ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins emax6_0/ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins proc_sys_reset_1/interconnect_aresetn]
  ...
  assign_bd_address -offset 0x000400000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs emax6_0/axi_s/reg0] -force
