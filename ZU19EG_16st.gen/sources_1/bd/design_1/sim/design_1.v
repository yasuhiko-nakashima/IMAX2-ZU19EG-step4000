...
module design_1
  ...
  design_1_emax6_0_0 emax6_0
       (.ACLK(clk_wiz_0_clk_out2),
        ...
        .axi_s_araddr(axi_smc_M00_AXI_ARADDR),
        .axi_s_arburst(axi_smc_M00_AXI_ARBURST),
        .axi_s_arcache(axi_smc_M00_AXI_ARCACHE),
        .axi_s_arid({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .axi_s_arlen(axi_smc_M00_AXI_ARLEN),
        .axi_s_arprot(axi_smc_M00_AXI_ARPROT),
        .axi_s_arready(axi_smc_M00_AXI_ARREADY),
        .axi_s_arsize(axi_smc_M00_AXI_ARSIZE),
        .axi_s_arvalid(axi_smc_M00_AXI_ARVALID),
        .axi_s_awaddr(axi_smc_M00_AXI_AWADDR),
        .axi_s_awburst(axi_smc_M00_AXI_AWBURST),
        .axi_s_awcache(axi_smc_M00_AXI_AWCACHE),
        .axi_s_awid({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .axi_s_awlen(axi_smc_M00_AXI_AWLEN),
        .axi_s_awprot(axi_smc_M00_AXI_AWPROT),
        .axi_s_awready(axi_smc_M00_AXI_AWREADY),
        .axi_s_awsize(axi_smc_M00_AXI_AWSIZE),
        .axi_s_awvalid(axi_smc_M00_AXI_AWVALID),
        .axi_s_bready(axi_smc_M00_AXI_BREADY),
        .axi_s_bresp(axi_smc_M00_AXI_BRESP),
        .axi_s_bvalid(axi_smc_M00_AXI_BVALID),
        .axi_s_rdata(axi_smc_M00_AXI_RDATA),
        .axi_s_rlast(axi_smc_M00_AXI_RLAST),
        .axi_s_rready(axi_smc_M00_AXI_RREADY),
        .axi_s_rresp(axi_smc_M00_AXI_RRESP),
        .axi_s_rvalid(axi_smc_M00_AXI_RVALID),
        .axi_s_wdata(axi_smc_M00_AXI_WDATA),
        .axi_s_wlast(axi_smc_M00_AXI_WLAST),
        .axi_s_wready(axi_smc_M00_AXI_WREADY),
        .axi_s_wstrb(axi_smc_M00_AXI_WSTRB),
        .axi_s_wvalid(axi_smc_M00_AXI_WVALID));
